...
if __name__ == '__main__':
    ...
    while True:
        ...
        #print("high_state.velocity = {}".format(state.velocity))
        
        # print(motiontime)
        # print(state.imu.rpy[0])
        print(motiontime, state.motorState[0].q, state.motorState[1].q, state.motorState[2].q)
        print(motiontime, state.motorState[3].q, state.motorState[4].q, state.motorState[5].q)
        print(motiontime, state.motorState[6].q, state.motorState[7].q, state.motorState[8].q)
        print(motiontime, state.motorState[9].q, state.motorState[10].q, state.motorState[11].q)
        print("====="*10)
        # print(state.imu.rpy[0])
